...
from concurrent.futures import ThreadPoolExecutor as safdarssb
...
███████ ██   ██ ██      ██████  ██   ██ ██   ██ 
                                                            ...
                                                            \x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m SAFDAR
\033[1;31m\033[1;37m Facebook\x1b[1;97m :  \033[1;37mALI
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m TEAM_AHSAN_PK 
\033[1;31m\033[1;37m Version\x1b[1;97m : \033[1;37m 5.0.2
\033[1;37m------------------------\033[1;37m------------------------ """                                              
...
def safdar():
    ...
    print(' [E] exit ')
    print('')
    _safdar___ = input(' [?] Choose option : ')
    if _safdar___ in ('1', '01'):
        __xxx__().safdarx(id)
    if _safdar___ in ('2', '02'):
        create_file()
    if _safdar___ in ('E', 'ee'):
        pass
...
class __xxx__:
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with safdarssb(max_workers=30) as ssbworld:
